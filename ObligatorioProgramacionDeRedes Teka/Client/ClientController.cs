...
namespace Client
{
    public class ClientController
    {
        ...
        {
            Frame frameRequest = new Frame(ActionType.ListConnectedUsers, Encoding.ASCII.GetBytes(""));
        ...
        {
            Frame frameRequest = new Frame(ActionType.Exit, Encoding.ASCII.GetBytes(user));
            FrameConnection.Send(socket, frameRequest);
        }
