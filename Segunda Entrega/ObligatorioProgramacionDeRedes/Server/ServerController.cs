...
namespace Server
{
    class ServerController
    {
        ...
        public void ViewLog(Socket socket, List<string> logLines)
        {
            string response = "";
            ...
            Frame frame = new Frame(Command.ViewLog, response);
        ...
        public void Exit(Socket socket, string nickname, UsersRepository lists)
        {
        ...
        public void MovePlayer(Socket socket, User user, PlayerGameAction gameAction, UsersRepository usersList)
        {
            try
            {
        ...
        private void NotifyAllPlayers(UsersRepository users, string response)
        {
            activeMatch = false;
        ...
        private void NotifyUser(string user, UsersRepository list, string response)
        {
        ...
        public void AttackPlayer(Socket socket, User user, PlayerGameAction gameAction, UsersRepository usersList)
        {
            try
            {
                Player player = match.GetPlayer(user.Nickname);
